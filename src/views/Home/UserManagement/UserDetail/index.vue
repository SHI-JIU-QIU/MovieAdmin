<template>
  <div class="w-100% mt-10 flex  justify-center items-center  bg-white">
    ...
    <Form ref="formRef" :config="userFormConfig.formItems" :model-value="user" @update:model-value="change"
      class="rounded border-l-0.5 flex-1 border-gray-200 items-center p-14" formStyle="grid grid-cols-2 gap-8" itemStyle="w-100%">
      <template #footer>
        <div class="flex flex-col items-center	w-40%">
          <div>
            <el-button v-if="formEl" type="primary" class="" @click="updateUser(formEl)">修改资料</el-button>
          </div>
        </div>
      </template>
    </Form>
